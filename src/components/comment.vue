...
<!--   标题部分 -->
    <div class="header-title">
      ...
      <div class="title"> 长评-- {{commentsMsg.subject.title}}</div>
      <div class="back"></div>
    </div>
  ...
  <div class="discuss">
    <div v-for="item in commentsMsg.reviews">
       <div class="rating">
        ...
        <p class="author-content" :class="{showall:showall}" @click="click_showall"> {{item.content}} </p>
        <div class="img"> 
...
export default {
  ...
  methods:{
    ...
    click_showall:function(showall){
